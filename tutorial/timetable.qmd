...
Learn how to create shiny applications in R starting from the basics. This workshop will introduce the core concepts of shiny app development, including: designing a user interface, writing reactive server code, troubleshooting common errors, and deploying your app. During the workshop we will build and publish a simple interactive dashboard, which displays a plot that changes based on a few inputs. Participants are expected to be familiar with writing R code, but no prior experience in website development or shiny is required to get the most out of this workshop.
